...
#SBATCH --job-name sheet12_lua_mimalloc
# Redirect output stream to this file
#SBATCH --output=output12_lua_mimalloc.log
...
basedir="$scratchdir/sheet12_lua_mimalloc$$"
nruns=10
...
(
    cd "$scratchdir"
    [ ! -d mimalloc ] && git clone https://github.com/microsoft/mimalloc
...
(
    ...
    for run in $(seq 1 $nruns); do
        ...
        LD_PRELOAD="$scratchdir/mimalloc/out/release/libmimalloc.so" \
